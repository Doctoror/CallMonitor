...
class CallLogPresenter(
    ...
    // Arguably, having the property below public is a Law of Demeter violation, however, this
    // accessor will be used only once and having a viewModel here provides more benefits of
    // ensuring the same instance for a presenter
